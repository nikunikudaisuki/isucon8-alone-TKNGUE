...
mysql -uisucon torb -e 'ALTER TABLE reservations ADD KEY user_id (user_id)'
mysql -uisucon torb -e 'ALTER TABLE events ADD KEY pub_evt (public_fg, id)'
mysql -uisucon torb -e 'ALTER TABLE seets ADD KEY rank (rank)'
